...
public partial class IncomingViewModel : BaseViewModel
{
	...
	public IncomingViewModel(SampleDataService service)
	{
		dataService = service;
	}
	...
	{
		await Shell.Current.GoToAsync(nameof(IncomingDetailPage), true, new Dictionary<string, object>
		{
			{ "Item", item }
		});
	}
